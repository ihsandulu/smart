...
<head>
    ...
    <style>
        ...
        .wrap-login100{opacity:0.96;}
        #logo{width:auto; height:100px; margin: 0px;}
            ...
            <div class="wrap-login100">
                <form action="<?= base_url('login'); ?>" method="POST" class="login100-form validate-form p-l-55 p-r-55 p-t-178">
                    ...
                    <div class="wrap-input100 validate-input m-b-16" data-validate="Please enter NIK">
                        <input autofocus class="input100" type="text" name="user_email" placeholder="Email">
					...
					<div class="flex-col-c p-t-15 p-b-40">
						...
						<a href="<?= base_url("signup");?>" class="txt3">
							Sign up now
						</a>
					</div>
